...
where there is a dataset called `airway`. We load this dataset
by using `data()` function.
...
The TCGA subtype is avaialble at . Can you compare the consistency to the subgroup
